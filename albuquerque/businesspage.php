...
$map = new Map();
$map->setAPIKey("ABQIAAAAoIxEzse0hCAeXEJftW8hWhSESZ5UQzobY3DBgvYXwy1RTTpd_RQNVzoVRw-v0uiT88GoOms_B08R7w");
...
echo "<title>- Albuquerque - $row[name] - $row[keywords2] - $row[city], $row[state] $row[zip]</title> \n";
echo "<meta name=\"keywords\" content=\" -Albuquerque - $row[name],$telephone[telephone], $row[address], $row[keywords2]\"> \n";
echo "<meta name=\"description\" content=\"$row[name] - Albuquerque - business search - $row[keywords2]\"> \n";

echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";
echo "</head><body><center> \n";
echo "<div id=\"wrap\"> \n";
echo "<div id=\"header\"><h1><strong>Albuquerque</strong><br>New Mexico Yellowpages</h1>
</div>\n";
echo "<div id=\"content\"> \n";
