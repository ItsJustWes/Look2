...
$map = new Map();
$map->setAPIKey("ABQIAAAAoIxEzse0hCAeXEJftW8hWhQ6wAJPCZqGnP85Jatch62F2boDEhSpJI95c4x_vrx3KciJtJR4jLzlRQ");
...
echo "<title>- Fort Collins - $row[name] - $row[keywords2] - $row[city], $row[state] $row[zip]</title> \n";
echo "<meta name=\"keywords\" content=\"fort collins, $row[name],$telephone[telephone], $row[address], $row[keywords2]\"> \n";
echo "<meta name=\"description\" content=\"$row[name] - Fort Collins - business search - $row[keywords2]\"> \n";
echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";
echo "</head><body><center> \n";
echo "<div id=\"wrap\"> \n";

echo "<div id=\"header\"><h1><strong>Fort Collins</strong><br>Colorado Yellowpages</h1>
</div>\n";
echo "<div id=\"content\"> \n";
...
echo "<center><div style=\"font-size:10px; width:728px;\">";
...
echo "</div></center>";
echo "<center>";
printf("<font face='verdana' size='2'>%s<br><font size=\"1\">If you are <h1>%s</h1> and would like to update your listing<br>email us at update@look2yellowpages.com.</font>\n", $row["description"], $row["name"]);
