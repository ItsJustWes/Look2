...
echo "<title>$q $city, Alta | Alberta Business</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q $city, $city Alberta, $city Alta, alberta business, alberta canada, alberta, canada business, alta business, alberta business directory \">\n";
printf("<meta name=\"description\" content=\"$q, $city Alberta - Businesses on this street \">  \n",  $row["name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px;">Alberta Business | Alta Canada | Street Search</h2>
</div>
...
echo " <font face='Verdana' color='#000000' size='2'> &nbsp;&nbsp;<b>Businesses near $q - $city, Alta </b>\n";
