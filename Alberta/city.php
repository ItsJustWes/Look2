...
function ReturnMatches($q, $c, $name, $matches, $first, $ads)
{
	      ...
	      $DATABASE_NAME   = 'alberta_alberta';
	      $DATABASE_USER   = 'alberta_dub';
...
echo "<title>$c Alberta| Alta Business| $c Business</title>\n";

echo "<meta name=\"keywords\" content=\"$c, $c alta, $c alberta, $c business, alberta business, alberta canada, alberta, canada business, alta business, alberta business directory, Alta City Search\"> \n";

echo "<meta name=\"description\" content=\"Alberta Business - $c Business - $c Alta\"> \n";
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Alberta Business | Alberta City Search </h2>
</div>
...
<div align="center">
<?PHP
echo "<b><font face=\"Verdana\" size=\"5\">&nbsp;$c Alta | Alberta Business </font></b>\n";
?>
</div>
...
<div align="center">
  ...
  <?php
echo "       <b><font face=\"Verdana\" color=\"#000000\" size=\"2\">Search $c, Alberta Business Listings</font> </b>\n";
echo "</div> \n";
...
echo "<b><font face=\"Verdana\" size=\"2\" color=\"#000000\">&nbsp; $c, Alberta Quick Category \n";
echo "  Listings:&nbsp;&nbsp; </font>\n";
