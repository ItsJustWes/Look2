...
echo "<title>$q | Alberta Business | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$q Alberta, $q business, $q alta, $q Alberta business, $q alta business, business search \">\n";
printf("<meta name=\"description\" content=\"$q - Alberta Business - All $q Businesses\">  \n",  $row["name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Alberta Business | Search</h2>
</div>
...
<table border="0" width="100%">
  <tr>
    <td>
    <p align="left">
      <font face="verdana" size="5"><b>Alberta Business Search</b></font></td>
  </tr>
  </table>
