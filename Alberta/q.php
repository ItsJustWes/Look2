...
echo "<title> $q Alberta | Alta Business | Category Results</title>	\n";
echo "<meta name=\"keywords\" content=\"$q alta, $q Alberta, $q search alberta, alberta business, alberta canada, alberta, canada business, alta business, alberta business directory, $q business,  \">\n";
printf("<meta name=\"description\" content=\"$q Alberta - Alberta Business - category results\">  \n",  $row["Name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Alberta Business | Alta Canada | Category Results</h2>
</div>
...
<table border="0" width="500px">
  <tr>
    <td>
    <p align="center">
      <font face="verdana" size="5"><b>Alberta Business - Search Results</b></font></td>
  </tr>
  </table>
