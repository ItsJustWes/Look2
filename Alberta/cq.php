...
printf("<title>%s - %s | Alberta Business</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c Alberta, $c Alta, $q search $c, alta business, alberta business, alta canada \" >\n";
printf("<meta name=\"description\" content=\"%s - %s Alberta\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Alberta Business | Alta Canada | Alta Business</h2>
</div>
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c - Alberta Business</b></font></td>\n";
...
<div align="center">
 ...
 <form style=action="cq.php" method=get>
  ...
  <?php
echo "       <center><b><font face=\"Verdana\" color=\"#000000\" size=\"2\">Search $c - Alta Business</font> </b></center>\n";
