...
printf("<title>%s - %s | Nova Scotia Business</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c Nova Scotia, $c NS, $q search $c, nova scotia business, nova scotia business, nova scotia canada \" >\n";
printf("<meta name=\"description\" content=\"%s - %s Nova Scotia\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Nova Scotia Business | NS Canada | NS Business</h2>
</div>
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c - Nova Scotia Business</b></font></td>\n";
...
<div align="center">
 ...
 <form style=action="cq.php" method=get>
  ...
  <?php
echo "       <center><b><font face=\"Verdana\" color=\"#000000\" size=\"2\">Search $c - NS Business</font> </b></center>\n";
