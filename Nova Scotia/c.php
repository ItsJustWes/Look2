...
echo "<title>$q | Nova Scotia Business | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$q Nova Scotia, $q business, $q nova scotia, $q Nova Scotia business, $q nova scotia business, business search \">\n";
printf("<meta name=\"description\" content=\"$q - Nova Scotia Business - All $q Businesses\">  \n",  $row["name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Nova Scotia Business | Search</h2>
</div>
...
<table border="0" width="100%">
  <tr>
    <td>
    <p align="left">
      <font face="verdana" size="5"><b>Nova Scotia Business Search</b></font></td>
  </tr>
  </table>
