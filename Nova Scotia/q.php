...
echo "<title> $q Nova Scotia | NS Business | Category Results</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q Nova Scotia, $q search, nova scotia business, nova scotia canada, nova scotia, canada business, nova scotia business, nova scotia business directory, $q business,  \">\n";
printf("<meta name=\"description\" content=\"$q Nova Scotia - NS Business - Category Results\">  \n",  $row["Name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Nova Scotia Business | NS Canada | Category Results</h2>
</div>
...
<table border="0" width="500px">
  <tr>
    <td>
    <p align="center">
      <font face="verdana" size="5"><b>Nova Scotia Business - Search Results</b></font></td>
  </tr>
  </table>
