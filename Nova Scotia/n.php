...
echo "<title>$q $city, NS | Nova Scotia Business</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q $city, $city Nova Scotia, $city NS, nova scotia business, nova scotia canada, nova scotia, canada business, nova scotia business, nova scotia business directory \">\n";
printf("<meta name=\"description\" content=\"$q, $city Nova Scotia - Businesses on this street \">  \n",  $row["name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px;">Nova Scotia Business | NS Canada | Street Search</h2>
</div>
...
echo " <font face='Verdana' color='#000000' size='2'> &nbsp;&nbsp;<b>Businesses near $q - $city, NS </b>\n";
