...
$map = new Map();
$map->setAPIKey("ABQIAAAAoIxEzse0hCAeXEJftW8hWhSmdeqvbgKAC2N9wPvSLyOy2RapihTjxraMnCJhKKqAeRXOkS0HIk90Gg");
...
echo "<meta name=\"description\" content=\"$row[name] - Las Vegas - business search - $row[keywords2]\"> \n";
echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";
echo "</head><body><center> \n";
echo "<div id=\"wrap\"> \n";

echo "<div id=\"header\"><h1><strong>Las Vegas</strong><br>Nevada Yellowpages</h1>
</div>\n";
echo "<div id=\"content\"> \n";
