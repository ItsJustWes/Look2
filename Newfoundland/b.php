...
<script src="http://maps.google.com/maps?file=api&v=2&key=ABQIAAAAoIxEzse0hCAeXEJftW8hWhTMwIwzK3u7HXipLY4p2V9zJNf4fxQxLo4vlKHNOWFpOCDfRo1ZuACvFw"
...
<script type="text/javascript">
    ...
    function load() {
      if (GBrowserIsCompatible()) {
        ...
        map.setCenter(new GLatLng(55.078367, -59.787598), 6);
...
echo "<h2 style=\"font-size:12px\">Newfoundland Business | Newfoundland Canada</h2></div> \n";

echo "<div id=\"wrap\"> \n";
echo "<div id=\"header\"><br /><h1><strong>Newfoundland</strong></h1>
</div>\n";
echo "<div id=\"content\"> \n";
