...
printf("<title>%s - %s | Newfoundland Business</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c Newfoundland, $c Labrador, $q search $c, labrador business, newfoundland business, labrador canada \" >\n";
printf("<meta name=\"description\" content=\"%s - %s Newfoundland\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Newfoundland Business | Labrador Canada | Labrador Business</h2>
</div>
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c - Newfoundland Business</b></font></td>\n";
...
<div align="center">
 ...
 <form style=action="cq.php" method=get>
  ...
  <?php
echo "       <center><b><font face=\"Verdana\" color=\"#000000\" size=\"2\">Search $c - Labrador Business</font> </b></center>\n";
