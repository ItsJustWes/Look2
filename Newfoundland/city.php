...
echo "<title>$c Newfoundland | Labrador Business| $c Business</title>\n";

echo "<meta name=\"keywords\" content=\"$c, $c labrador, $c newfoundland, $c business, newfoundland business, newfoundland canada, newfoundland, canada business, labrador business, newfoundland business directory, Labrador City Search\"> \n";

echo "<meta name=\"description\" content=\"Newfoundland Business - $c Business - $c Labrador\"> \n";
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Newfoundland Business | Newfoundland City Search </h2>
</div>
...
<div align="center">
<?PHP
echo "<b><font face=\"Verdana\" size=\"5\">&nbsp;$c Newfoundland | Newfoundland Business </font></b>\n";
?>
</div>
...
<div align="center">
  ...
  <?php
echo "       <b><font face=\"Verdana\" color=\"#000000\" size=\"2\">Search $c, Newfoundland Business Listings</font> </b>\n";
echo "</div> \n";
...
echo "<b><font face=\"Verdana\" size=\"2\" color=\"#000000\">&nbsp; $c, Newfoundland Quick Category \n";
echo "  Listings:&nbsp;&nbsp; </font>\n";
