...
echo "<title> $q Newfoundland | $q Labrador | Category Results</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q Newfoundland, $q search, $q labrador, newfoundland business, newfoundland canada, newfoundland, canada business, labrador business, newfoundland business directory, $q business,  \">\n";
printf("<meta name=\"description\" content=\"$q Newfoundland - Newfoundland Business - Category Results\">  \n",  $row["Name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Newfoundland Business | Labrador Canada | Category Results</h2>
</div>
...
<table border="0" width="500px">
  <tr>
    <td>
    <p align="center">
      <font face="verdana" size="5"><b>Newfoundland Business - Search Results</b></font></td>
  </tr>
  </table>
