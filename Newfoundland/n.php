...
echo "<title>$q $city, Labrador | Newfoundland Business</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q $city, $city Newfoundland, $city Labrador, newfoundland business, newfoundland canada, newfoundland, canada business, labrador business, newfoundland business directory \">\n";
printf("<meta name=\"description\" content=\"$q, $city Newfoundland - Businesses on this street \">  \n",  $row["name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px;">Newfoundland Business | Labrador Canada | Street Search</h2>
</div>
