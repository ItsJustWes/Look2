...
echo "<title>$c, $s Yellowpages</title>\n";
echo "<meta name=\"keywords\" content=\"$c, $s Yellowpages\">	\n";
echo "<meta name=\"description\" content=\"$c, $s Yellowpages\"> 	\n";
?>
...
<?php
echo "        <a title=\"$s Yellowpages Home\" href=\"province.php?s=$s\">$s Home</a>\n";
?>
...
<center><b><font face=\"Verdana\" size=\"3\">$c Categories 
  <br /><br /><font face=\"Verdana\" color=\"#000000\" size=\"2\">
