...
$map = new Map();
$map->setAPIKey("ABQIAAAAoIxEzse0hCAeXEJftW8hWhSBeinPjiE5DSUS8N_VMpEo8y2pPxTPWqVrdo96F1h5Zy0Znjv9fx1Giw");
...
echo "<title>- Indianapolis - $row[name] - $row[keywords2] - $row[city], $row[state] $row[zip]</title> \n";
echo "<meta name=\"keywords\" content=\"Indianapolis, $row[name],$telephone[telephone], $row[address], $row[keywords2]\"> \n";
echo "<meta name=\"description\" content=\"$row[name] - Indianapolis - business search - $row[keywords2]\"> \n";
echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";
echo "</head><body><center> \n";
echo "<div id=\"wrap\"> \n";

echo "<div id=\"header\"><h1><strong>Indianapolis</strong><br>Indiana Yellowpages</h1>
</div>\n";
echo "<div id=\"content\"> \n";
