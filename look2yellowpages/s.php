...
echo "<title>$q in $s  | $q | $s Business</title>\n";
echo "<meta name=\"keywords\" content=\"$s Yellowpages, business search, $q, $s business, $q $s, address lookup, business yellowpages, $s Business Search, yellowpages directory, online yellowpages\">	\n";
echo "<meta name=\"description\" content=\"Look2 $s Yellowpages - Business Search - $q in $s\"> 	\n";
...
<?php
echo    "<h2 style=\"font-size:12px\">Look2 Yellowpages | $q in $s | Business Search</h2> \n";
?>
</div>
...
<?php
echo "        <a title=\"Go To $c Yellowpages Home\" href=\"state.php?s=$s\">Home</a>\n";
?>
        <font face="Times New Roman" size="2">&#9642;</font>
<font face="Verdana" size="2">
<?php
echo "        <a title=\"Over 850 Business Categories\" href=\"statecategories.php?s=$s\">$s Business Categories</a></font></b></td></tr></table>\n";
