...
<table border="0" width="100%">
  ...
  <?php
echo "       <b><font face=\"Verdana\" color=\"#800000\" size=\"2\">Search - $c, $s - Business Listings</font> </b><br>\n";
...
<?php
echo "        <a title=\"Over 850 Business Categories\" href=\"city.php?c=$c&s=$s\">$c, $s -  Business Listings</a></font></b>\n";
?>
...
echo "<table width=\"100%\"><tr><td width=\"50%\" align=\"left\" valign='top'>\n";
	...
	if ($first == 0) {
		...
		echo "<a style=\"color:#800000;\" href=\"?q=" . $q . "&matches=" . $matches ."&s=" . $s . "&first=" . ($first-$matches) . "&c=" . $c . "\" ><font face=\"Verdana\" size=\"2\" color='#800000'>Prev</a>  | ";
	}
	echo "   ";
	if ($no_results == 1) {
		echo "Next";
	} else {
	echo "<a style=\"color:#800000;\" href=\"?q=" . $q . "&matches=" . $matches . "&s=" . $s ."&first=" . ($first+$matches) .  "&c=" . $c . "\" ><font face=\"Verdana\" size=\"2\" color='#800000'>Next</a></font>&nbsp;&nbsp;<br />\n";
	}
