...
echo "<h2 style=\"font-size:12px\">Searchable Business Directory - over 23 Million Records - Look2Yellowpages.com</h2></div> \n";

echo "<div id=\"wrap\"> \n";
echo "<a href=\"/\"><div id=\"header\"><h1><strong>Yellowpages</strong></h1>
</div></a>\n";
echo "<div id=\"content\"> \n";
