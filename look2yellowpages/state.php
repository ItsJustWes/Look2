...
echo "<title>$s Yellowpages | Address Lookup | $s Business</title>\n";
echo "<meta name=\"keywords\" content=\"$s Yellowpages, business search, US Yellowpages, $s business, Business Listings, address lookup, business yellowpages, $s Business Search, yellowpages directory, online yellowpages\">	\n";
echo "<meta name=\"description\" content=\"Look2 $s Yellowpages - Business Search - $s Address Lookup \"> 	\n";
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Look2 | US Yellowpages | Address Lookup | Business Search</h2>
</div>
...
<?php
echo "        <a title=\"Go To Yellowpages Home\" href=\"/\">Home</a>\n";
?>
...
<center><b><h2>$s</h2><br><font style=\"color:#800000;\">Base Categories</font> 
  ...
  <a href=\"statecategories.php?s=$s\" style=\"color:#800000;\">
