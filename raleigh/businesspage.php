...
$map = new Map();
$map->setAPIKey("ABQIAAAAoIxEzse0hCAeXEJftW8hWhRY5lm2KjX2e7QqNpx4UaJyempBMBTkJZzGuJ-EkOhog1ztoeh8VieebA");
...
echo "<title>- Raleigh - $row[name] - $row[keywords2] - $row[city], $row[state] $row[zip]</title> \n";
echo "<meta name=\"keywords\" content=\"raleigh, $row[name],$telephone[telephone], $row[address], $row[keywords2]\"> \n";
echo "<meta name=\"description\" content=\"$row[name] - Raleigh - business search - $row[keywords2]\"> \n";
echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";
echo "</head><body><center> \n";
echo "<div id=\"wrap\"> \n";

echo "<div id=\"header\"><h1><strong>Raleigh</strong><br>North Carolina Yellowpages</h1>
</div>\n";
...
echo "<div align=\"center\"><table border=\"0\" width=\"10%\" cellspacing=\"0\" style=\"border: 1 inset #800000\"><tr>   <td>\n";
$map->showMap();
echo "</td>  </tr></div>\n";
echo "</td>  </tr></table>\n";
