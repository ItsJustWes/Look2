...
$map = new Map();
$map->setAPIKey("ABQIAAAAoIxEzse0hCAeXEJftW8hWhRoi5PHzJbUplSU6lV-IZGS2JkfDxSJvdSp1jwH3jo-RNH7f5nw06Q4nQ");
...
echo "<title>- Tucson - $row[name] - $row[keywords1] - $row[city], $row[state] $row[zip]</title> \n";
echo "<meta name=\"keywords\" content=\"tucson, $row[name],$telephone[telephone], $row[address], $row[keywords2]\"> \n";
echo "<meta name=\"description\" content=\"$row[name] - Tucson - business search - $row[keywords2]\"> \n";
echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";
echo "</head><body><center> \n";
echo "<div id=\"wrap\"> \n";

echo "<div id=\"header\"><h1><strong>Tucson</strong><br>Arizona Yellowpages</h1>
</div>\n";
echo "<div id=\"content\"> \n";
