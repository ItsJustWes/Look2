...
$map = new Map();
$map->setAPIKey("ABQIAAAAoIxEzse0hCAeXEJftW8hWhRWts5zYvwIzDg5Tq-uw6I6EN6ywBTkmQFvkgiHE_HiZb31afuXsJQeeQ");
...
echo "<title>- Charlotte - $row[name] - $row[keywords2] - $row[city], $row[state] $row[zip]</title> \n";
echo "<meta name=\"keywords\" content=\" - charlotte - $row[name],$telephone[telephone], $row[address], $row[keywords2]\"> \n";
echo "<meta name=\"description\" content=\"$row[name] - Charlotte - business search - $row[keywords2]\"> \n";
echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";

echo "</head><body><center> \n";
echo "<div id=\"wrap\"> \n";
echo "<div id=\"header\"><h1><strong>Charlotte</strong><br>North Carolina Yellowpages</h1>
</div>\n";
