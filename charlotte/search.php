...
echo "<title>Charlotte | North Carolina Yellowpages | Charlotte $q</title>	\n";
echo "<meta name=\"keywords\" content=\"Charlotte, Charlotte North Carolina, business search, charlotte $q, charlotte business, charlotte yellowpages, north carolina yellowpages, Look2 yellowpages\">\n"; 
echo "<meta name=\"description\" content=\"Charlotte North Carolina Yellowpages and Business Search - $q\">  \n"; 
...
<body><center>
<div id="wrap">
<div id="header"><h1><strong>Charlotte</strong><br>North Carolina Yellowpages</h1>
</div>
<div id="content">
<div align="center"> 

<p><font face="Verdana" size="2" color="#800000"><b>Business Search</b>:</font></p>
...
<b><font face="Verdana" size="2">&nbsp; Charlotte | Business 
      Search:&nbsp;&nbsp; </font>
...
echo "<td width=\"50%\"><p align=\"right\"><b>\n";
	...
	if ($first == 0) {
		...
		echo "<a style=\"text-decoration: none\" href=\"search.php?q=" . $q . "&matches=" . $matches . "&first=" . ($first-$matches) . "&ads=" . ($ads-3) . "\" ><font face=\"Verdana\" size=\"1\" color='#800000'>Prev</a>  | ";
	}
	echo "   ";
	if ($no_results == 1) {
		echo "Next";
	} else {
	echo "<a style=\"text-decoration: none\" href=\"search.php?q=" . $q . "&matches=" . $matches . "&first=" . ($first+$matches) .  "&ads=" . ($ads+3) . "\" ><font face=\"Verdana\" size=\"1\" color='#800000'>Next</a></font>&nbsp;&nbsp;\n";
	}
...
var sc_project=2303146; 
var sc_invisible=1; 
var sc_partition=21; 
var sc_security="ec148de5"; 
</script>

<script type="text/javascript" language="javascript" src="http://www.statcounter.com/counter/counter.js"></script><noscript><a href="http://www.statcounter.com/" target="_blank"><img  src="http://c22.statcounter.com/counter.php?sc_project=2303146&amp;java=0&amp;security=ec148de5&amp;invisible=1" alt="simple hit counter" border="0"></a> </noscript>
<!-- End of StatCounter Code -->

<div id="footer">Copyright (c) 2006-2008 All Rights Reserved - Look2 Yellowpages - <a href="http://look2charlotte.net/privacypolicy.html">Privacy Policy</a>
</div>
</div>
</div></center>
</body></html>
