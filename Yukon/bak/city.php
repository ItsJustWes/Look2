...
function ReturnMatches($q, $c, $name, $matches, $first, $ads)
{
	      ...
	      $DATABASE_NAME   = 'yuk_yuk';
	      $DATABASE_USER   = 'yuk_dub';
...
echo "<title>$c Yukon | $c Business</title>\n";

echo "<meta name=\"keywords\" content=\"$c, $c yukon, $c business, yukon business, yukon territory, yukon, canada business, yukon business directory\"> \n";

echo "<meta name=\"description\" content=\"$c Businesses - $c Yukon, featuring local businesses with addresses, phone numbers and maps\"> \n";
?>
...
<div id="wrap">
   	<div id="header"><img src="/look2yellowpages1.jpg" align="left" alt="Yukon territory">
	<br /><h1><strong>Yukon</strong></h1>
	</div>
<div id="content">	

<div align="center">
<?PHP
echo "<b><font face=\"Verdana\" size=\"5\">&nbsp;$c Yukon | Yukon Territory </font></b>\n";
?>
</div>
...
<div align="center">
 ...
 <?php
echo "       <b><font face=\"Verdana\" color=\"#000000\" size=\"2\">Search $c, Yukon Business Listings</font> </b>\n";
echo "</div> \n";
...
echo "<b><font face=\"Verdana\" size=\"2\" color=\"#000000\">&nbsp; $c, Yukon Quick Category \n";
echo "  Listings:&nbsp;&nbsp; </font>\n";
