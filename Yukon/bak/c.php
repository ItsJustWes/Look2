...
echo "<title>$q | Yukon Territoy | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$q Yukon, $q business, $q Yukon business, $q business search, yukon territory \">\n";
printf("<meta name=\"description\" content=\"$q Yukon Territory - All $q businesses with addresses, phone number and maps\">  \n",  $row["name"]);
?>
...
<table border="0" width="100%">
  <tr>
    <td>
    <p align="left">
      <font face="verdana" size="5"><b>Yukon Territory Business Search</b></font></td>
  </tr>
  </table>
