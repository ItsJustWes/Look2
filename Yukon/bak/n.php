...
echo "<title>$q $city | Yukon Territoy</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q $city, $city Yukon, yukon territory, yukon business, yukon canada, yukon, yukon business directory \">\n";
printf("<meta name=\"description\" content=\"$q, $city Yukon - Businesses on this street featuring addresses, phone numbers and maps.\">  \n",  $row["name"]);
...
<div id="wrap">
	...
	<img src="/look2yellowpages1.jpg" align="left" alt="Yukon business"><br>
