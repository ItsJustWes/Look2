...
printf("<title>%s %s | Yukon Territory</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c Yukon, $q search $c, yukon business, labrador canada \" >\n";
printf("<meta name=\"description\" content=\"%s %s - Yukon Territory, Canada\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<div id="wrap">
	...
	<img src="/look2yellowpages1.jpg" align="left" alt="Yukon business">
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c Business - Yukon Territory</b></font></td>\n";
