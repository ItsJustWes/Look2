...
printf("<title>%s %s | Northwest Territories Business</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c Northwest Territories, $q search $c, Northwest Territories business, labrador canada \" >\n";
printf("<meta name=\"description\" content=\"%s %s - Northwest Territories Canada\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c Business - Northwest Territories</b></font></td>\n";
