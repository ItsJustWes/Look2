...
echo "<title>$q | Northwest Territories Business | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$q Northwest Territories, $q business, $q Northwest Territories business, $q business search \">\n";
printf("<meta name=\"description\" content=\"$q Northwest Territories Business - All $q Businesses with addresses, phone number and maps\">  \n",  $row["name"]);
?>
...
<table border="0" width="100%">
  <tr>
    <td>
    <p align="left">
      <font face="verdana" size="5"><b>Northwest Territories Business Search</b></font></td>
  </tr>
  </table>
