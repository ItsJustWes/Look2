...
echo "<title> $q Northwest Territories | Category Results</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q Northwest Territories, $q search, Northwest Territories business, Northwest Territories canada, Northwest Territories, Northwest Territories business directory, $q business Northwest Territories,  \">\n";
printf("<meta name=\"description\" content=\"$q Northwest Territories - Northwest Territories business results featuring addresses, phone numbers and maps\">  \n",  $row["Name"]);
?>
...
<table border="0" width="500px">
  <tr>
    <td>
    <p align="center">
      <font face="verdana" size="5"><b>Northwest Territories Business - Search Results</b></font></td>
  </tr>
  </table>
