...
echo "<title>- Portland - $row[name] - $row[keywords2] - $row[city], $row[state] $row[zip]</title> \n";
echo "<meta name=\"keywords\" content=\"portland, $row[name],$telephone[telephone], $row[address], $row[keywords2]\"> \n";
echo "<meta name=\"description\" content=\"$row[name] - Portland - business search - $row[keywords2]\"> \n";
echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";
echo "</head><body><center> \n";
echo "<div id=\"wrap\"> \n";

echo "<div id=\"header\"><h1><strong><!-- google_ad_section_start -->  <Portland</strong><br>Oregon <!-- google_ad_section_end -->Yellowpages</h1>
</div>\n";
echo "<div id=\"content\"> \n";
...
printf("<b><font face='verdana' size='3'>%s<br>  \n", $row["name"]);
