...
printf("<title>%s - %s | Quebec Business</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c Quebec, $c Quebec, $q search $c, quebec canada business, quebec business, quebec canada \" >\n";
printf("<meta name=\"description\" content=\"%s - %s Quebec\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Quebec Business | Quebec Canada | Quebec Business</h2>
</div>
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c - Quebec Business</b></font></td>\n";
...
<div align="center">
 ...
 <form style=action="cq.php" method=get>
  ...
  <?php
echo "       <center><b><font face=\"Verdana\" color=\"#000000\" size=\"2\">Search $c - Quebec Business</font> </b></center>\n";
