...
echo "<title> $q Quebec | Quebec Business | Category Results</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q Quebec, $q search, quebec business, quebec canada, quebec, canada business, quebec business directory, $q business,  \">\n";
printf("<meta name=\"description\" content=\"$q Quebec - Quebec Business - Category Results\">  \n",  $row["Name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Quebec Business | Quebec Canada | Category Results</h2>
</div>
...
<table border="0" width="500px">
  <tr>
    <td>
    <p align="center">
      <font face="verdana" size="5"><b>Quebec Business - Search Results</b></font></td>
  </tr>
  </table>
