...
echo "<title>$q | Quebec Business | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$q Quebec, $q business, $q quebec canada, $q Quebec business, $q business search \">\n";
printf("<meta name=\"description\" content=\"$q - Quebec Business - All $q Businesses\">  \n",  $row["name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">Quebec Business | Search</h2>
</div>
...
<table border="0" width="100%">
  <tr>
    <td>
    <p align="left">
      <font face="verdana" size="5"><b>Quebec Business - Search</b></font></td>
  </tr>
  </table>
