...
echo "<title>$q $city | Nunavut Business</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q $city, $city Nunavut, nunavut business, nunavut canada, nunavut, nunavut business directory \">\n";
printf("<meta name=\"description\" content=\"$q, $city Nunavut - Businesses on this street featuring addresses, phone numbers and maps.\">  \n",  $row["name"]);
