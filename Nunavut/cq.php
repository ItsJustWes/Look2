...
printf("<title>%s %s | Nunavut Business</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c Nunavut, $q search $c, nunavut business, labrador canada \" >\n";
printf("<meta name=\"description\" content=\"%s %s - Nunavut Canada\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c Business - Nunavut</b></font></td>\n";
...
<div align="center">
 ...
 <form style=action="cq.php" method=get>
  ...
  <?php
echo "       <center><b><font face=\"Verdana\" color=\"#000000\" size=\"2\">$c Business Search</font> </b></center>\n";
