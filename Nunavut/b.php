...
printf("<meta name=\"keywords\" content=\"%s, %s, %s, %s, %s, %s, nunavut, %s %s\">  \n",  $row["Name"], $row["Telephone"], $row["Address"], $row["Keywords1"], $row["City"], $row["Province"], $row["Keywords1"], $row["City"]);
printf("<meta name=\"description\" content=\"%s  - %s - %s %s\">  \n",  $row["Name"], $row["Keywords1"], $row["City"], $row["Province"]);
echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";
?>


<script src="http://maps.google.com/maps?file=api&v=2&key=ABQIAAAAoIxEzse0hCAeXEJftW8hWhQNcfo_M5tctxWdnR2f09wjeGzvgBTT6O7wGSlH3SlC7GJPVZ2LnFcIYg"
...
<script type="text/javascript">
    ...
    function load() {
      if (GBrowserIsCompatible()) {
        ...
        map.setCenter(new GLatLng(69.3700, -81.8200), 7);
...
echo "<div id=\"wrap\"> \n";
echo "<div id=\"header\"><img src=\"/look2yellowpages1.jpg\" align=\"left\" alt=\"Nunavut business\"><br /><h1><strong>Nunavut</strong></h1>
</div>\n";
echo "<div id=\"content\"> \n";
