...
printf("<title>%s - %s, Minnesota | Business Search</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c Minnesota, $q search $c\" >\n";
printf("<meta name=\"description\" content=\"%s - %s, Minnesota\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c, Minnesota Yellowpages</b></font></td>\n";
...
<td>
  ...
  <?php
echo "       <center><b><font face=\"Verdana\" color=\"#000000\" size=\"2\">Search $c, Minnesota Yellowpages</font> </b></center>\n";
