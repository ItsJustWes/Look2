...
echo "<title>$q $city, Minnesota | Business Search</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $city Minnesota \">\n";
printf("<meta name=\"description\" content=\"$q, $city Minnesota Businesses on this street \">  \n",  $row["name"]);
?>
...
echo " <font face='Verdana' color='#000000' size='2'> &nbsp;&nbsp;<b>Businesses near $q - $city, Minnesota </b>\n";
...
<?PHP
echo "<td width=\"75%\"><p align=\"left\"><b>\n";
