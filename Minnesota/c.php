...
echo "<title>$q Minnesota | $city $q | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$city $q, $q Minnesota, $q business, $q Search, $q Minnesota business, $q Minnesota search, business search \">\n";
printf("<meta name=\"description\" content=\"$city $q, $q Minnesota Business Search - All $q Businesses\">  \n",  $row["city"], $row["name"]);
?>
...
echo " <font face='Verdana' color='#000000' size='2'> &nbsp;&nbsp;<b>$city $q</b>\n";
