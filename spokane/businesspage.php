...
$map = new Map();
$map->setAPIKey("ABQIAAAAoIxEzse0hCAeXEJftW8hWhRYPzLt0q8MNTMNaxukBukwqAFiOxTahTNE9841n-M_dUw1c6RSg7jZNg");
...
echo "<title>- Spokane - $row[name] - $row[keywords2] - $row[city], $row[state] $row[zip]</title> \n";
echo "<meta name=\"keywords\" content=\"spokane, $row[name],$telephone[telephone], $row[address], $row[keywords2]\"> \n";
echo "<meta name=\"description\" content=\"$row[name] - Spokane - business search - $row[keywords2]\"> \n";
echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";
echo "</head><body><center> \n";
echo "<div id=\"wrap\"> \n";

echo "<div id=\"header\"><h1><strong>Spokane</strong><br>Washington Yellowpages</h1>
</div>\n";
echo "<div id=\"content\"> \n";
...
echo "<div align=\"center\"><table border=\"1\" width=\"10%\" cellspacing=\"0\" style=\"border: 1 inset #FFFFFF\"><tr>   <td>\n";
$map->showMap();
echo "</td>  </tr></div>\n";
echo "</td>  </tr></table>\n";
