...
printf("<title>%s | %s | %s Prince Edward Island</title> \n", $row["Name"], $row["Keywords1"], $row["City"], $row["Province"]);
printf("<meta name=\"keywords\" content=\"%s, %s, %s, %s, %s, %s, prince edward island, %s %s\">  \n",  $row["Name"], $row["Telephone"], $row["Address"], $row["Keywords1"], $row["City"], $row["Province"], $row["Keywords1"], $row["City"]);
printf("<meta name=\"description\" content=\"%s  - %s - %s %s\">  \n",  $row["Name"], $row["Keywords1"], $row["City"], $row["Province"]);
echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";
?>


<script src="http://maps.google.com/maps?file=api&v=2&key=ABQIAAAAoIxEzse0hCAeXEJftW8hWhTrpZYj52oFCr1C7ovBUjePVVr33xTc13OF9R3O_Ctv4MbwcriOgoES1A"
...
<script type="text/javascript">
    ...
    function load() {
      if (GBrowserIsCompatible()) {
        ...
        map.setCenter(new GLatLng(46.238551, -63.126187), 8);
...
echo "<div id=\"wrap\"> \n";
echo "<div id=\"header\"><img src=\"/look2yellowpages1.jpg\" align=\"left\" alt=\"Prince Edward Island business\"><br /><h1><strong>Prince Edward Island</strong></h1>
</div>\n";
echo "<div id=\"content\"> \n";
