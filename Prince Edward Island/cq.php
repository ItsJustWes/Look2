...
printf("<title>%s %s | Prince Edward Island Business</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c Prince Edward Island, $q search $c, prince edward island business, labrador canada \" >\n";
printf("<meta name=\"description\" content=\"%s %s - Prince Edward Island Canada\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c Business - Prince Edward Island</b></font></td>\n";
