...
echo "<title>$q | Prince Edward Island Business | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$q Prince Edward Island, $q business, $q Prince Edward Island business, $q business search \">\n";
printf("<meta name=\"description\" content=\"$q Prince Edward Island Business - All $q Businesses with addresses, phone number and maps\">  \n",  $row["name"]);
?>
...
<table border="0" width="100%">
  <tr>
    <td>
    <p align="left">
      <font face="verdana" size="5"><b>Prince Edward Island Business Search</b></font></td>
  </tr>
  </table>
