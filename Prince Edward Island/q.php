...
echo "<title> $q Prince Edward Island | Category Results</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q Prince Edward Island, $q search, prince edward island business, prince edward island canada, prince edward island, prince edward island business directory, $q business prince edward island,  \">\n";
printf("<meta name=\"description\" content=\"$q Prince Edward Island - Prince Edward Island business results featuring addresses, phone numbers and maps\">  \n",  $row["Name"]);
?>
...
<table border="0" width="500px">
  <tr>
    <td>
    <p align="center">
      <font face="verdana" size="5"><b>Prince Edward Island Business - Search Results</b></font></td>
  </tr>
  </table>
