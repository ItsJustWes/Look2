...
$map = new Map();
$map->setAPIKey("ABQIAAAAoIxEzse0hCAeXEJftW8hWhSeQCjqeVJr6q1mpnIOdMljrsiQUBQwnuDgh62s-DmQkLVDCxuuvTyY0w");
...
echo "<title>- Phoenix - $row[name] - $row[keywords2] - $row[city], $row[state] $row[zip]</title> \n";
echo "<meta name=\"keywords\" content=\"phoenix, $row[name],$telephone[telephone], $row[address], $row[keywords2]\"> \n";
echo "<meta name=\"description\" content=\"$row[name] - Phoenix - business search - $row[keywords2]\"> \n";
echo "<link rel=\"stylesheet\" href=\"/dub.css\" type=\"text/css\"/>\n";
echo "</head><body><center> \n";
echo "<div id=\"wrap\"> \n";

echo "<div id=\"header\"><h1><strong>Phoenix</strong><br>Arizona Yellowpages</h1>
</div>\n";
echo "<div id=\"content\"> \n";
...
$row[keywords2] in Glendale Arizona</a>";
 echo " | ";
  echo "<a href=\"http://www.look2minnesota.com/$row[keywords2].htm\">
$row[keywords2] in Minnesota</a>";
