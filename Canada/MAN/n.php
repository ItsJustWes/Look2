...
echo "<title>$q $city, BC | British Columbia Business</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q $city, $city British Columbia, $city BC, british columbia business, british columbia canada, british columbia, canada business, bc business, british columbia business directory \">\n";
printf("<meta name=\"description\" content=\"$q, $city British Columbia - Businesses on this street \">  \n",  $row["name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px;">British Columbia Business | BC Canada | Street Search</h2>
</div>
...
echo " <font face='Verdana' color='#000000' size='2'> &nbsp;&nbsp;<b>Businesses near $q - $city, BC </b>\n";
