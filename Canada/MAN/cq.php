...
printf("<title>%s - %s | British Columbia Business</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c British Columbia, $c BC, $q search $c, bc business, british columbia business, bc canada \" >\n";
printf("<meta name=\"description\" content=\"%s - %s British Columbia\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">British Columbia Business | BC Canada | BC Business</h2>
</div>
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c - British Columbia Business</b></font></td>\n";
...
<div align="center">
 ...
 <form style=action="cq.php" method=get>
  ...
  <?php
echo "       <center><b><font face=\"Verdana\" color=\"#000000\" size=\"2\">Search $c - BC Business</font> </b></center>\n";
