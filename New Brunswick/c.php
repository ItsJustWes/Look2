...
echo "<title>$q | New Brunswick Business | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$q New Brunswick, $q business, $q nb, $q New Brunswick business, $q nb business, business search \">\n";
printf("<meta name=\"description\" content=\"$q - New Brunswick Business - All $q Businesses\">  \n",  $row["name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">New Brunswick Business | Search</h2>
</div>
...
<table border="0" width="100%">
  <tr>
    <td>
    <p align="left">
      <font face="verdana" size="5"><b>New Brunswick Business Search</b></font></td>
  </tr>
  </table>
