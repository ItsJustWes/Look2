...
echo "<title> $q New Brunswick | New Brunswick Category Results</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q New Brunswick, $q search, new brunswick business, new brunswick canada, new brunswick, canada business, nb business, new brunswick business directory, $q business,  \">\n";
printf("<meta name=\"description\" content=\"$q New Brunswick - New Brunswick business  category results\">  \n",  $row["Name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">New Brunswick Business | Nouveau-Brunswick Canada | Category Results</h2>
</div>
...
<table border="0" width="500px">
  <tr>
    <td>
    <p align="center">
      <font face="verdana" size="5"><b>New Brunswick Business - Search Results</b></font></td>
  </tr>
  </table>
