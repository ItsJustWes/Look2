...
echo "<title>$q $city, Nouveau-Brunswick | New Brunswick Business</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $q $city, $city New Brunswick, $city Nouveau-Brunswick, new brunswick business, new brunswick canada, new brunswick, canada business, nb business, new brunswick business directory \">\n";
printf("<meta name=\"description\" content=\"$q, $city New Brunswick - Businesses on this street \">  \n",  $row["name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px;">New Brunswick Business | Nouveau-Brunswick Canada | Street Search</h2>
</div>
...
<OPTION>New Brunswick Directory
...
echo " <font face='Verdana' color='#000000' size='2'> &nbsp;&nbsp;<b>Businesses near $q - $city, Nouveau-Brunswick </b>\n";
