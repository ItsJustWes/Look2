...
echo "<title>$q | British Columbia Business | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$q British Columbia, $q business, $q bc, $q British Columbia business, $q bc business, business search \">\n";
printf("<meta name=\"description\" content=\"$q - British Columbia Business - All $q Businesses\">  \n",  $row["name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px">British Columbia Business | Search</h2>
</div>
...
<table border="0" width="100%">
  <tr>
    <td>
    <p align="left">
      <font face="verdana" size="5"><b>BC Business - Search</b></font></td>
  </tr>
  </table>
