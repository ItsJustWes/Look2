...
echo "<title>$q Washington | Business Search | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$q Washington, $q business, $q Search, $q washington business, $q washington search, business search \">\n";
printf("<meta name=\"description\" content=\"$q Washington Business Search - All $q Businesses\">  \n",  $row["name"]);
?>
...
<div id="content">	
<?php
echo "<table border=\"0\" width=\"100%\"><tr><td> <p align=\"center\"> \n";  	
echo "<font face=\"verdana\" size=\"5\"><b> $q Washington Yellowpages</b></font> \n";
echo "</p></td></tr></table> \n"; 
...
echo " <font face='Verdana' color='#800000' size='2'>&nbsp;&nbsp;&nbsp;&nbsp;<b>$q</b>&nbsp;&nbsp;\n";
