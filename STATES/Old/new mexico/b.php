...
$map = new Map();
$map->setAPIKey("ABQIAAAAoIxEzse0hCAeXEJftW8hWhSUwv9Hl2lYY2DgVXfqAMuT8LDShBRg13z0BshqdZSucA3s4tidsaskIw");
...
echo "<meta name=\"keywords\" content=\"$keywords, New Mexico\">\n";
...
echo "<h2 style=\"font-size:12px\">New Mexico Yellowpages and Business Search</h2></div> \n";

echo "<div id=\"wrap\"> \n";
echo "<div id=\"header\"><h1><strong>New Mexico</strong></h1>
</div>\n";
echo "<div id=\"content\"> \n";
...
echo "        <tr><td width=\"100%\"><font color=\"#000000\" face=\"Verdana\" Size=\"3\"><center><b>&nbsp;Support \n";
