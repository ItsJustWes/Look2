...
echo "<title>$q New Mexico | Business Search | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$q New Mexico, $q business, $q Search, $q New Mexico business, $q New Mexico search, business search \">\n";
printf("<meta name=\"description\" content=\"$q New Mexico Business Search - All $q Businesses\">  \n",  $row["name"]);
?>
