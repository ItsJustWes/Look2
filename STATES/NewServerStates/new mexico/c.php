...
echo "<title>$q New Mexico | $city $q | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\" $city $q , $q New Mexico, $q business, $q Search, $q New Mexico business, $q New Mexico search, business search \">\n";
printf("<meta name=\"description\" content=\" $city $q , $q New Mexico Business Search - All $q Businesses\">  \n",  $row["city"], $row["name"]);
?>
...
echo " <font face='Verdana' color='#800000' size='2'> &nbsp;&nbsp;<b>$city $q</b>\n";
