...
printf("<title>%s - %s, Utah | Business Search</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c Utah, $q search $c\" >\n";
printf("<meta name=\"description\" content=\"%s - %s, Utah\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c, Utah Yellowpages</b></font></td>\n";
...
<td>
  ...
  <?php
echo "       <center><b><font face=\"Verdana\" color=\"#000000\" size=\"2\">Search $c, Utah Yellowpages</font> </b></center>\n";
