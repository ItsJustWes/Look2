...
echo "<title>$q $city, Utah | Business Search</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $city Utah \">\n";
printf("<meta name=\"description\" content=\"$q, $city Utah Businesses on this street \">  \n",  $row["name"]);
?>
...
<table border="0" width="100%">
  <tr>
    <td>
    <p align="center">
      <font face="verdana" size="5"><b>Yellowpages</b></font></td>
  </tr>
  </table>
...
<OPTION VALUE="Video and DVD.htm">Video Stores
    ...
    <td>
<font face="Verdana" size="2" color="#800000"><b><a href="categories.php">All Business Categories</a></b></font>
&nbsp;</td>
  </tr></table>
</td></tr> </div> </form>
    </tr>
...
echo " <font face='Verdana' color='#000000' size='2'> &nbsp;&nbsp;<b>Businesses near $q - $city, Utah </b>\n";
...
echo "<td width=\"30%\"><p align=\"right\"><b>\n";
	...
	if ($first == 0) {
		...
		echo "<a style=\"text-decoration: none\" href=\"n.php?q=" . $q . "&matches=" . $matches . "&first=" . ($first-$matches) . "&ads=" . ($ads-3) . "\" ><font face=\"Verdana\" size=\"2\" color='#800000'>Prev</a>  | ";
	}
	echo "   ";
	if ($no_results == 1) {
		echo "Next";
	} else {
	echo "<a style=\"text-decoration: none\" href=\"n.php?q=" . $q . "&matches=" . $matches . "&first=" . ($first+$matches) .  "&ads=" . ($ads+3) . "\" ><font face=\"Verdana\" size=\"2\" color='#800000'>Next</a></font>&nbsp;&nbsp;\n";
	}
echo "</td></tr></table></b>&nbsp;&nbsp;\n";
