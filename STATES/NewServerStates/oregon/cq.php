...
echo "<html>	\n";
echo "<head>	\n";
printf("<title>%s - %s, Oregon | Business Search</title> \n", $row["Keywords1"], $row["City"]);
echo "<meta name=\"keywords\" content=\"$q $c, $c Oregon, $q search $c\" >\n";
printf("<meta name=\"description\" content=\"%s - %s, Oregon\">  \n", $row["Keywords1"], $row["City"]);
?>
...
<?PHP
echo "      <font face=\"verdana\" size=\"4\"><b>$c, Oregon Yellowpages</b></font></td>\n";
...
<td>
  ...
  <?php
echo "       <center><b><font face=\"Verdana\" color=\"#800000\" size=\"2\">Search $c, Oregon Yellowpages</font> </b></center>\n";
