...
echo "<title>$q $city, Oregon | Business Search</title>	\n";
echo "<meta name=\"keywords\" content=\"$q, $city Oregon \">\n";
printf("<meta name=\"description\" content=\"$q, $city Oregon Businesses on this street \">  \n",  $row["name"]);
?>
...
<div style="background-color:#FFFF00; width:100%; height:12px;">
    <h2 style="font-size:12px;">Oregon Yellowpages - Business Search - Street Addresses</h2>
</div>
...
echo " <font face='Verdana' color='#000000' size='2'> &nbsp;&nbsp;<b>Businesses near $q - $city, Oregon </b>\n";
