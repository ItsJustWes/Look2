...
echo "<title>$q Oregon | Business Search | $q Businesses</title>	\n";
echo "<meta name=\"keywords\" content=\"$q Oregon, $q business, $q Search, $q Oregon business, $q Oregon search, business search \">\n";
printf("<meta name=\"description\" content=\"$q Oregon Business Search - All $q Businesses\">  \n",  $row["name"]);
?>
